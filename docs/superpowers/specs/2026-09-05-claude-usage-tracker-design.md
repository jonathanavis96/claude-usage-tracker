...
session that starts and exits in between aborts it too. An account whose
seven-day meter reads above 90% is passed over as well, and the log names that
reason apart from a busy one. Both are on Max 20x, the
